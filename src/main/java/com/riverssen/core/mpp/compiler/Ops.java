...
//    aaload(29, "load a reference onto the stack from a local object"),
    ...
    binc("increment a byte on the stack"),
    sinc("increment a short on the stack"),
    iinc("increment an int on the stack"),
    linc("increment a long on the stack"),
    liinc("increment a 128bit integer on the stack"),
    llinc("increment a 256bit integer on the stack"),
    finc("increment a fload on the stack"),
    dinc("increment a double on the stack"),
    dfinc("increment a 128bit float on the stack"),
    ddinc("increment a 256bit float on the stack"),

    bdec("decrement a byte on the stack"),
    sdec("decrement a short on the stack"),
    idec("decrement an integer on the stack"),
    ldec("decrement a long on the stack"),
    lidec("decrement a 128bit integer on the stack"),
    lldec("decrement a 256bit integer on the stack"),
    fdec("decrement a float on the stack"),
    ddec("decrement a double on the stack"),
    dfdec("decrement a 128bit float on the stack"),
    dddec("decrement a 256bit float on the stack"),

    ltn("a less than b (register)"),
    gtn("a greater than b (register)"),
    lte("a less than or equal to b (register)"),
    gte("a greater than or equal to b (register)"),
    and,
    or,
    eq,
    if_ct,
