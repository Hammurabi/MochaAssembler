...
//    bfstore("store a float into object"),
    ...
    mrega_2,
    mrega_3,
    ptb("store a byte into a heap variable"),
    pts("store a short into a heap variable"),
    pti("store an integer into a heap variable"),
    ptl("store a long into a heap variable"),
    ptli("store a 128bit integer into a heap variable"),
    ptll("store a 256bit integer into a heap variable"),
    ptf("store a float into a heap variable"),
    ptd("store a double into a heap variable"),
    ptdf("store a 128bit float into a heap variable"),
    ptdd("store a 256bit float into a heap variable"),
    pta("store a reference into a heap variable"),
    ptcs("store a string into a heap variable"),
    ;
//    sin,
//    cos,
//    tan
